...
namespace tlc
{
    ...
    struct VulkanBufferSettings {
        ...
        inline VulkanBufferSettings &SetSize(Size s)
        {
            size = s;
            return *this;
        }
        inline VulkanBufferSettings &SetUsage(vk::BufferUsageFlags u)
        {
            usage = u;
            return *this;
        }
        inline VulkanBufferSettings &SetMemoryPropertyFlags(vk::MemoryPropertyFlags flags)
        {
            memoryPropertyFlags = flags;
            return *this;
        }
        inline VulkanBufferSettings &SetSharingMode(vk::SharingMode mode)
        {
            sharingMode = mode;
            return *this;
        }
        inline VulkanBufferSettings &SetUseDeviceMemoryPool(Bool u)
        {
    ...
    struct VulkanBufferUploadSettings {
        ...
        inline VulkanBufferUploadSettings &SetOffset(Size o)
        {
            offset = o;
            return *this;
        }
        inline VulkanBufferUploadSettings &SetQueueType(VulkanQueueType type)
        {
            queueType = type;
            return *this;
        }
        inline VulkanBufferUploadSettings &SetStagingBuffer(Ref<VulkanBuffer> buff)
        {
            stagingBuffer = buff;
            return *this;
        }
    ...
    public:
        ...
        inline vk::BufferUsageFlags GetUsageFlags() const
        {
            return m_UsageFlags;
        }
        inline Size GetMappedSize() const
        {
            return m_MappedSize;
        }
        inline Size GetMappedOffset() const
        {
            return m_MappedOffset;
        }

        inline VulkanBufferSettings &GetSettings()
        {
            return m_Settings;
        }

        inline void *GetMappedDataRaw() const
        {
            return m_MappedData;
        }

        template <typename T>
        inline Raw<T> GetMappedData() const
        {
