...
namespace tlc
{
    ...
    struct VulkanGraphicsPipelineSettings {
        ...
        inline VulkanGraphicsPipelineSettings &SetExtent(const vk::Extent2D &ex)
        {
            this->extent = ex;
            return *this;
        }
        inline VulkanGraphicsPipelineSettings &SetVertexShaderModule(Ref<VulkanShaderModule> shModule)
        {
            this->vertexShaderModule = std::move(shModule);
            return *this;
        }
        inline VulkanGraphicsPipelineSettings &SetFragmentShaderModule(Ref<VulkanShaderModule> shModule)
        {
            this->fragmentShaderModule = std::move(shModule);
            return *this;
        }
        inline VulkanGraphicsPipelineSettings &SetRenderPass(vk::RenderPass r)
        {
            this->renderPass = r;
            return *this;
        }
        inline VulkanGraphicsPipelineSettings &ClearVertexInputAttributeDescriptions()
        {
            this->vertexInputAttributeDescriptions    = {};
            this->vertexInputBindingDescriptionStride = 0;
            return *this;
        }

        template <typename T>
            requires(HasGetAttributeDescriptions<T>)
        inline VulkanGraphicsPipelineSettings &SetVertexInputAttributeDescriptions()
        {
            this->vertexInputAttributeDescriptions = T::GetAttributeDescriptions();
            vertexInputBindingDescriptionStride    = sizeof(T);
            return *this;
        }

        inline VulkanGraphicsPipelineSettings &AddPushConstantRange(vk::ShaderStageFlags stageFlags, U32 offset, U32 size)
        {
            this->pushConstantRanges.push_back(vk::PushConstantRange().setStageFlags(stageFlags).setOffset(offset).setSize(size));
            return *this;
        }
        inline VulkanGraphicsPipelineSettings &ClearPushConstantRanges()
        {
            this->pushConstantRanges.clear();
            return *this;
        }

        inline VulkanGraphicsPipelineSettings &AddDescriptorSetLayout(vk::DescriptorSetLayout l)
        {
            this->descriptorSetLayouts.push_back(l);
            return *this;
        }
        inline VulkanGraphicsPipelineSettings &ClearDescriptorSetLayouts()
        {
            this->descriptorSetLayouts.clear();
            return *this;
        }

        inline VulkanGraphicsPipelineSettings &SetPipelineColorBlendAttachmentState(vk::PipelineColorBlendAttachmentState b)
        {
            this->blendAttachmentState = b;
            return *this;
        }
    };
    ...
    public:
        ...
        inline const VulkanGraphicsPipelineSettings &GetSettings() const
        {
            return m_Settings;
        }
        inline VulkanGraphicsPipelineSettings &GetSettings()
        {
            return m_Settings;
        }
