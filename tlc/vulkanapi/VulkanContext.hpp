...
namespace tlc
{
    ...
    public:
        ...
        inline static VulkanContext *Get()
        {
            if (!s_Instance)
                s_Instance = CreateScope<VulkanContext>();
        ...
        inline const List<CString> &GetExtensions() const
        {
            return m_Extensions;
        }
        inline const List<CString> &GetLayers() const
        {
            return m_Layers;
        }
