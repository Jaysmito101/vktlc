...
namespace tlc
{
    ...
    public:
        ...
        inline VulkanDeviceSettings &SetRequireComputeQueue(Bool require)
        {
            requireComputeQueue = require;
            return *this;
        }

        inline VulkanDeviceSettings &SetGraphicsQueuePriority(float priority)
        {
            graphicsQueuePriority = priority;
            return *this;
        }
        inline VulkanDeviceSettings &SetComputeQueuePriority(float priority)
        {
            computeQueuePriority = priority;
            return *this;
        }
        inline VulkanDeviceSettings &SetTransferQueuePriority(float priority)
        {
            transferQueuePriority = priority;
            return *this;
        }
    };
    ...
    public:
        ...
        inline I32 GetGraphicsQueueFamilyIndex() const
        {
            return m_QueueFamilyIndices[Graphics];
        }
        inline I32 GetComputeQueueFamilyIndex() const
        {
            return m_QueueFamilyIndices[Compute];
        }
        inline I32 GetTransferQueueFamilyIndex() const
        {
            return m_QueueFamilyIndices[Transfer];
        }
        inline I32 GetPresentQueueFamilyIndex() const
        {
        ...
        inline Raw<VulkanContext> GetParentContext() const
        {
        ...
        inline const VulkanDeviceSettings &GetSettings() const
        {
            return m_Settings;
        }
        inline const vk::Queue &GetQueue(VulkanQueueType type) const
        {
            return m_Queues[type];
        }
        inline const vk::CommandPool &GetCommandPool(VulkanQueueType type) const
        {
